...
![Voting System On WWW](./images/www-love-login.png)

On `staging.love.htb`, we find some file scanner.

![Staging Love File Uploader](./images/staging-love-home.png)
...
![Port 5000 Forbidden](./images/port-5000-forbidden.png)
...
![Upload Hello.txt](./images/file-uploader-1.png)
...
![Intercept Upload Send To Repeater](./images/file-uploader-intercept-send-to-repeater.png)
...
![Burp Upload Hello.php](./images/file-uploader-burp-hello-php.png)
...
![Leaked Admin Credentials](./images/file-uploader-admin-creds.png)
...
![Voting System Admin Access](./images/voting-system-admin.png)
...
![NT System Shell](./images/nt-system-shell.png)
