...
const Greeting = ({ githubUrl, twitterUrl, linkedinUrl }: GreetingProps) => (
  <section className="relative mx-auto max-w-7xl lg:px-8 h-full">
    <div className="flex justify-center items-center h-full">
      <div className="max-w-2xl mt-[-60px]">
        ...
        <p className="mt-6 mb-6 text-base text-center text-black dark:text-white max-w-md">
          ...
          thoughts on DevOps, system design, reliability and software
          development. I also tinker with home automation in my spare time.
          Let’s connect if you’re into resilient systems or just love cool tech.
        </p>
